...
namespace RenderFeatures
{
    ...
    public class DesaturationRenderFeature : ScriptableRendererFeature
    {
        ...
        private DesaturationRenderPass _desaturationRenderPass;
        ...
        public override void Create()
        {
            ...
            _desaturationRenderPass = new DesaturationRenderPass(Settings)
            {
        ...
        public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
        {
            ...
            if (renderingData.cameraData.cameraType <= CameraType.SceneView)
                renderer.EnqueuePass(_desaturationRenderPass);
        }
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            _desaturationRenderPass.Dispose();
        }
    }
}